// JS for _outwear_carousel.html

        class OutwearCarousel {
            constructor() {
                ...
                this.currentIndex = 0;
                this.cardsToShow = Math.min(6, this.cards.length); // Show all cards if 6 or fewer
                this.cardWidth = 320;
                this.cardGap = 20;
            ...
            init() {
                ...
                this.cards.forEach(card => {
                    card.addEventListener('click', () => {
                        ...
                        // Future implementation: window.location.href = `/shop/clothing/outwear/${category}`;
                    });
                });
            }
            ...
            updateResponsiveSettings() {
                ...
                if (containerWidth <= 400) {
                    ...
                    // For outerwear carousel with 6 cards, show max 5 to ensure navigation is needed
            ...
            updateButtons() {
                ...
                // Always show navigation buttons for outerwear carousel (6 cards)
