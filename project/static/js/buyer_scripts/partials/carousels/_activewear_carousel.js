// JS for _activewear_carousel.html

        class ActivewearCarousel {
            constructor() {
            ...
            init() {
                ...
                this.cards.forEach(card => {
                    card.addEventListener('click', () => {
                        ...
                        // Future implementation: window.location.href = `/shop/clothing/activewear/${category}`;
                    });
                });
            }
