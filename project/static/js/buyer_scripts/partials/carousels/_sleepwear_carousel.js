// JS for _sleepwear_carousel.html

        class SleepwearCarousel {
            constructor() {
            ...
            init() {
                ...
                this.cards.forEach(card => {
                    card.addEventListener('click', () => {
                        ...
                        // Future implementation: window.location.href = `/shop/clothing/sleepwear/${category}`;
                    });
                });
            }
            ...
            updateResponsiveSettings() {
                ...
                if (containerWidth <= 400) {
                    ...
                    // For sleepwear carousel with 7 cards, show max 5 to ensure navigation is needed
